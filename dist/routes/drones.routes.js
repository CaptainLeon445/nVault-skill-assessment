...
const droneRegistrationValidation_1 = require("../validation/droneRegistrationValidation");
const router = express_1.default.Router();
router.post("/", droneRegistrationValidation_1.validateDroneRegistration, drones_controller_1.registerDrone);
